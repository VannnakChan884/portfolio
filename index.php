...
<body class="bg-primary dark:bg-secondary text-gray-800 dark:text-white min-h-screen transition-colors duration-300">
    ...
    <div id="app">
        ...
        <section id="about" class="py-16 bg-white dark:bg-gray-800">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-primary dark:text-white text-center mb-12"><?= $translations['about_title'] ?></h2>
                <div class="flex flex-col md:flex-row">
                    <div class="md:w-1/2 mb-8 md:mb-0">
                        <h3 class="text-xl font-semibold text-primary dark:text-white mb-4">Education & Career</h3>
                        <ul class="space-y-4">
                            <li class="flex items-start text-primary dark:text-white">
                                <i class="fa-solid fa-graduation-cap mt-1 mr-3"></i>
                                <div>
                                    <h4 class="font-medium"><?= $translations['education'] ?></h4>
                                    <p class="text-gray-500 dark:text-gray-400">Bachelor's Degree in Management Information Systems</p>
                                </div>
                            </li>
                            <li class="flex items-start text-primary dark:text-white">
                                <i class="fa-solid fa-briefcase mt-1 mr-3"></i>
                                <div>
                                    <h4 class="font-medium"><?= $translations['experience'] ?></h4>
                                    <p class="text-gray-500 dark:text-gray-400">Created visual concepts to communicate ideas</p>
                                </div>
                            </li>
                            <li class="flex items-start text-primary dark:text-white">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500 dark:text-gray-400">Providing technical assistance and network solutions</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="md:w-1/2 md:pl-12">
                        <h3 class="text-xl font-semibold text-primary dark:text-white mb-4">My Journey</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-semibold text-primary dark:text-white"><?= explode(':', $translations['design_skills'])[0] ?></h3>
                        </div>
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <div class="w-2 h-2 bg-accent rounded-full mr-3"></div>
                                <span class="text-gray-600 dark:text-white"><?= explode(':', $translations['design_skills'])[1] ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- IT Skills -->
                     <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-semibold text-primary dark:text-white"><?= explode(':', $translations['it_skills'])[0] ?></h3>
                        </div>
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <div class="w-2 h-2 bg-accent rounded-full mr-3"></div>
                                <span class="text-gray-600 dark:text-white"><?= explode(':', $translations['it_skills'])[1] ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Coding Skills -->
                     <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-semibold text-primary dark:text-white"><?= explode(':', $translations['code_skills'])[0] ?></h3>
                        </div>
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <div class="w-2 h-2 bg-accent rounded-full mr-3"></div>
                                <span class="text-secontext-gray-600 dark:text-white"><?= explode(':', $translations['code_skills'])[1] ?></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div v-for="project in projects" :key="project.id" class="project-card bg-gray-50 dark:bg-gray-800 rounded-lg overflow-hidden shadow-md">
                        ...
                        <div class="p-4">
                            <h3 class="text-lg font-semibold text-primary dark:text-white mb-2">{{ project.title }}</h3>
                            <p class="text-gray-600 text-sm dark:text-gray-300 mb-3">{{ project.description }}</p>
                            <div class="flex flex-wrap gap-2">
                                <span class="bg-gray-300 text-gray-600 dark:bg-white dark:text-gray-800 text-xs px-2 py-1 rounded">
                                    {{ project.category }}
                                </span>
                            </div>
                        </div>
        ...
        <section id="contact" class="py-16 bg-gray-50">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 text-gray-600 dark:text-white p-8 rounded-lg shadow-md">
